...
type Application struct {
	...
	GrantTypes               StringArray `json:"grant_types"`
	ResponseTypes            StringArray `json:"response_types"`
	RedirectURIs             StringArray `json:"redirect_uris"`
	PostLogoutURIs           StringArray `json:"post_logout_uris"`
