...
type Application struct {
	...
	GrantTypes               []string   `gorm:"type:jsonb" json:"grant_types"`
	ResponseTypes            []string   `gorm:"type:jsonb" json:"response_types"`
	RedirectURIs             []string   `gorm:"type:jsonb" json:"redirect_uris"`
	PostLogoutURIs           []string   `gorm:"type:jsonb" json:"post_logout_uris"`
